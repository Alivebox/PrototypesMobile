...
Ext.application({
    ...
    controllers: [
        ...
        'order.summary.OrderDocumentsController',
        'order.summary.OrderFormController',
        'order.summary.OrderDetailsController',
        'order.summary.OrderTasksController',
    ...
    views: [
        ...
        'order.summary.OrderTasks',
        'order.summary.OrderComments',
